      ...
      <div className="bg-customBlue w-full">
        <div className='flex flex-col'>
          <div className="flex flex-col w-full max-w-5xl mx-auto justify-between items-center ">
            ...
            <Link href="/">
            <Image src='/images/8.png' alt="logo" width={300} height={60} className="h-24 p-3 md:cursor-pointer" />
            ...
            <div className='flex justify-between items-center w-full mt-0'>
              ...
              <a href="tel:6477657484">
                <div className="bg-red-800 text-white p-2 rounded flex items-center gap-2 mb-2">
                  <IoCallOutline />
